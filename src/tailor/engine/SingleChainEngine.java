        ...
        for (int index = 0; index < chainDescription.size(); index++) {
            ...
            if (groupDescription.nameMatches(group)) {
                ...
                if (atomMatches.size() == groupDescription.size()) {
                    ...
                    Match groupMatch = 
                        new Match(groupDescription, matchingCopy);
                    if (groupMatch.satisfiesConditions(groupDescription)) {
                        for (Match atomMatch : atomMatches) {
                            groupMatch.addSubMatch(atomMatch);
                        }
